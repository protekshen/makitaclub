...
?>
    ...
    <footer id="colophon" class="site-footer mobile-container" role="contentinfo">
        <div class="container ">
            <div class="row">
            ...
            <div class="reveal" id="clubPriceModal" data-reveal>
                ...
                <p style="color:red;">Всем покупателям до <b>29.12.2017</b> товары по цене MakitaClub без покупки карты!(только для физ.лиц)</p>
