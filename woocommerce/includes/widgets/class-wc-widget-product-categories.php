...
class WC_Widget_Product_Categories extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$list_args['exclude'] = '122'; //Исключение категорий Оснастки
			//$list_args['child_of'] = 122; // Показать только категории Оснастки

			echo '<h3 class="widget-title">Каталог инструментов</h3>';
